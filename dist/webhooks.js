...
var get_pyaload_1 = require("./get-pyaload");
var ReceipEmail_1 = require("./components/emails/ReceipEmail");
...
var stripeWebhookHandler = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var webhookRequest, body, signature, event, session, payload, users, user, orders, order, mailOptions;
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, get_pyaload_1.getPayloadClient)()];
            case 1:
                payload = _c.sent();
            ...
            case 4:
                ...
                try {
                    mailOptions = {
                        ...
                        html: (0, ReceipEmail_1.ReceiptEmailHtml)({
                            date: new Date(),
                            email: user.email,
